...
public final class SystemServer {
    ...
    private static final String PHONEBOOK_SERVICE = "com.android.server.PhonebookService";
    ...
    private void startOtherServices() {
        ...
        PhonebookService phonebookservice = null;
        ...
        try {
            ...
            if (mFactoryTestMode == FactoryTest.FACTORY_TEST_LOW_LEVEL) {
             ...
             // traceBeginAndSlog("PhonebookService");
            try {
                Log.i("Phonebook", "Starting PhonebookService in SystemServer!!! ");
                phonebookservice = new PhonebookService(context);
                ServiceManager.addService(Context.PHONEBOOK_SERVICE, phonebookservice);
            } catch (Exception e) {
                Log.i("Phonebook", "Error on SystemServer: " + e);
            }
            // traceEnd();
