...
final class SystemServiceRegistry {
    ...
    static {
        ...
        registerService(Context.PHONEBOOK_SERVICE, PhonebookManager.class,
            new CachedServiceFetcher<PhonebookManager>() {
                @Override
                public PhonebookManager createService(ContextImpl ctx) throws ServiceNotFoundException  {
                    IBinder binder = ServiceManager.getService(Context.PHONEBOOK_SERVICE);
                    IPhonebookService service = IPhonebookService.Stub.asInterface(binder);
                    Log.i("Phonebook","RegisterService on SystemServiceRegistry");
                    return new PhonebookManager(ctx, service);
                }
            }
        );
